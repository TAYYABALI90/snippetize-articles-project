    ...
    <section className="mt-16 w-full max-w-xl">
      ...
      <div className="flex flex-col w-full gap-2">
        ...
        <form className="relative flex justify-center items-center" onSubmit={handleSubmit}>
          ...
          <button type="submit" className="submit_btn peer-focus:border-gray-800 peer-focus:text-gray-800">↵</button>
        ...
        <div className="flex flex-col gap-1 max-h-60 overflow-y-auto">
          ...
          {allArticles.map((item, index) => (
            ...
            <div className="link_card" key={`link-${index}`} onClick={() => setArticle(item)}>
              ...
              <p className="flex-1 font-satoshi text-black/100 font-medium text-sm truncate">{item.url}</p>
